...
constexpr size_t ParamsSize0 = 44416;
constexpr size_t ParamsSize1 = 10;

const std::string ImgName = "1-28*28.png";

/// Declare LeNet forward function.
extern "C" void _mlir_ciface_forward0(MemRef<float, 2> *output0,
                                      MemRef<float, 2> *output1,
                                     MemRef<float, 1> *arg0,
                                     dip::Image<float, 4> *input);
extern "C" void _mlir_ciface_forward1(MemRef<float, 2> *output,
                                     MemRef<float, 1> *arg1,
                                     MemRef<float, 2> *output0,
                                     MemRef<float, 2> *output1);
...
int main() {
  ...
  intptr_t sizesOutput0[2] = {1, 84};
  intptr_t sizesOutput1[2] = {84, 10};
  ...
  MemRef<float, 2> output0(sizesOutput0);
  MemRef<float, 2> output1(sizesOutput1);
  ...
  _mlir_ciface_forward0(&output0, &output1, &paramsContainer0, &input);
  std::cout << "++++++++++" << std::endl;
  _mlir_ciface_forward1(&output, &paramsContainer1, &output0, &output1);
  std::cout << "++++++++++" << std::endl;
