module {
  func.func private @subgraph5_prefill(memref<4480x1536xf32, strided<[1536, 1], offset: ?>>, memref<1x1024x1536xf32, strided<[1572864, 1536, 1], offset: ?>>, memref<4480x1536xf32, strided<[1536, 1], offset: ?>>, memref<1536x4480xf32, strided<[4480, 1], offset: ?>>) -> memref<1024x1536xf32>
  func.func @forward5_prefill(%arg0: memref<20643840xf32>, %arg1: memref<1x1024x1536xf32>) -> memref<1024x1536xf32> {
    ...
    %cast_4 = memref.cast %arg1 : memref<1x1024x1536xf32> to memref<1x1024x1536xf32, strided<[1572864, 1536, 1], offset: ?>>
    ...
    %0 = call @subgraph5_prefill(%cast, %cast_4, %cast_5, %cast_6) : (memref<4480x1536xf32, strided<[1536, 1], offset: ?>>, memref<1x1024x1536xf32, strided<[1572864, 1536, 1], offset: ?>>, memref<4480x1536xf32, strided<[1536, 1], offset: ?>>, memref<1536x4480xf32, strided<[4480, 1], offset: ?>>) -> memref<1024x1536xf32>
    return %0 : memref<1024x1536xf32>
  }
}
