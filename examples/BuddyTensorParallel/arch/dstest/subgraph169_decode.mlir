...
module {
  func.func @subgraph169_decode(%arg0: tensor<1x1x1536xf32>, %arg1: tensor<1536xf32>, %arg2: tensor<151936x1536xf32>) -> tensor<1x1x151936xf32> {
    ...
    %15 = tosa.reshape %12 {new_shape = array<i64: 1, 1536>} : (tensor<1x1x1536xf32>) -> tensor<1x1536xf32>
    %cst = arith.constant dense<0.000000e+00> : tensor<1x151936xf32>
    %16 = linalg.matmul {cast = #linalg.type_fn<cast_signed>} ins(%15, %14 : tensor<1x1536xf32>, tensor<1536x151936xf32>) outs(%cst : tensor<1x151936xf32>) -> tensor<1x151936xf32>
    %17 = tosa.reshape %16 {new_shape = array<i64: 1, 1, 151936>} : (tensor<1x151936xf32>) -> tensor<1x1x151936xf32>
    return %17 : tensor<1x1x151936xf32>
  }
}
